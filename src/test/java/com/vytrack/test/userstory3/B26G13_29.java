...
public class B26G13_29 {
    ...
    public void cancelVehicleOdometer() throws InterruptedException {
        ...
        WebElement fleetModule = Driver.getDriver().findElement(By.xpath("//a[.='Fleet Management']"));
        String expectedResult = "Fleet Management";
        String actualResult = fleetModule.getText();
        Assert.assertEquals(actualResult,expectedResult,"Fleet module is not verified!");
    }
}